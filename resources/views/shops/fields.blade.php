...
<div class="col-12 custom-field-container">
    ...
    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
        ...
        <div class="form-group row ">
            {!! Form::label('brand_id','Brand',['class' => 'col-3 control-label text-right']) !!}
            <div class="col-9">
                {!! Form::select('brand_id', $brand, null, ['class' => 'select2 form-control',  ]) !!}
                <div class="form-text text-muted">Brand</div>
            </div>
        </div>
        <div class="form-group row ">
            {!! Form::label('governorate_id', 'Governorate',['class' => 'col-3 control-label text-right']) !!}
            <div class="col-9">
                {!! Form::select('governorate_id', $governorates, null, ['class' => 'select2 form-control']) !!}
          ...
          <div class="form-group row ">
            ...
            <div class="col-9">
                {!! Form::select('city_id', $cities, null, ['class' => 'select2 form-control']) !!}
