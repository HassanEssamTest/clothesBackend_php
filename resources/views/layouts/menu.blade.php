...
@can('factory.index')
    <li class="nav-item">
        ...
        <a class="nav-link {{ Request::is('factory*') ? 'active' : '' }}" href="{!! route('factory.index') !!}">@if($icons)
                <i class="nav-icon  fa fa-shopping-basket"></i>@endif<p>Factories products</p></a>
    </li>
@endcan
...
@can('shops.index')
    <li class="nav-item has-treeview {{ (Request::is('shops*') || Request::is('requestedShops*') || Request::is('galleries*') || Request::is('shopReviews*')) && !Request::is('shopsPayouts*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('brand.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('brand*') ? 'active' : '' }}" href="{!! route('brand.index') !!}">@if($icons)
                        <i class="nav-icon fa fa-cutlery"></i>@endif<p>Brands</p></a>
            </li>
        @endcan
            @can('galleries.index')
                <li class="nav-item">
...
@can('categories.index')
    <li class="nav-item has-treeview {{ (Request::is('categories*') || Request::is('colourCategories*') || Request::is('sizeCategories*') ||
        ...
        <ul class="nav nav-treeview">
            ...
            @can('clothesCategories.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('clothesCategories*') ? 'active' : '' }}" href="{!! route('clothesCategories.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-comments"></i>@endif<p>Clothes gender</p></a>
                </li>
                {{-- <li class="nav-item">
            ...
            @can('topCategories.index')
            <li class="nav-item">
                <a class="nav-link {{ Request::is('topCategories*') ? 'active' : '' }}" href="{!! route('topCategories.index') !!}">@if($icons)
                        <i class="nav-icon fa fa-image"></i>@endif<p>{{trans('lang.topCategory_plural')}}</p></a>
            </li>
            @endcan
        </ul>
    </li>
...
@can('governorate.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('governorate*') ? 'active' : '' }}" href="{!! route('governorate.index') !!}">@if($icons)<i class="nav-icon fa fa-map"></i>@endif<p>Governorate</p></a>
    </li>
@endcan
@can('city.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('city*') ? 'active' : '' }}" href="{!! route('city.index') !!}">@if($icons)<i class="nav-icon fa fa-map"></i>@endif<p>City</p></a>
    </li>
@endcan
...
@can('pricings.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('pricings*') ? 'active' : '' }}" href="{!! route('pricings.index') !!}">@if($icons)<i class="nav-icon fa fa-map"></i>@endif<p>Pricing</p></a>
    </li>
@endcan
