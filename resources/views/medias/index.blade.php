        ...
        <div id="mediaModal" class="card">
            <div class="card-header">
                <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                    ...
                    @hasanyrole('admin')
                        <li class="nav-item">
                            <a class="nav-link" href="{!! url('mediaLibrary/create') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.media_create')}}</a>
                        </li>                        
                    @endhasanyrole
                    <li class="nav-item">
                        <a class="nav-link" href="{!! url('mediaLibrary') !!}"><i class="fa fa-plus mr-2"></i>{{trans('lang.media_all')}}</a>
                    </li>
...
@push('scripts')
    <script type="text/template" data-template="mediaitem">
        <div class="media-item m-2">
            ...
            <a href="{!! url('mediaLibrary/get/${uuid}') !!}">Full Specification</a>           
        </div>
    </script>
    ...
    <script type="text/javascript">
        ...
        $('#mediaModal #refreshMedia').on('click', function () {
            loadMedia("{!! url('uploads/allLibrary') !!}/default");
        ...
        $('#selectCollection #collectionName').on('change', function () {
            loadMedia("{!! url('uploads/allLibrary') !!}/" + $(this).val());
        });
