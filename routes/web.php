...
Route::post('payment/callback', 'API\OrderAPIController@callback');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('storeImages','ClothesController@storeimage')->name('images.store');
    Route::resource('subcategory', 'SubCategoryController');
    Route::get('factory/all','FactoryController@all')->name('factory.all');
     Route::post('factory/filter', 'FactoryController@filter')->name('factory.filter');
    ...
    Route::group(['middleware' => ['permission:medias']], function () {
        ...
        Route::get('uploads/allLibrary/{collection?}', 'UploadController@allLibrary');
        ...
        Route::resource('mediaLibrary', 'MediaController');
        Route::get('mediaLibrary/get/{uuid}', 'MediaController@getUuid');
    ...
    Route::resource('topCategories', 'TopCategoryController')->except([
        'show'
    ]);
