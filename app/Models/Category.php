...
class Category extends Model implements HasMedia
{
    ...
    {
        return $this->belongsToMany(\App\Models\Clothes::class, 'category_clothes')->withCount('likes')
    ...
    {
        return $this->belongsToMany(\App\Models\Clothes::class, 'category_clothes');
    }
