...
class UserAPIController extends Controller
{
    ...
    function login(Request $request)
    {
        try {
            ...
            // , 'is_verified' => true
                ...
                return $this->sendError("Your account doesn't verified", 401);
            }
        } catch (\Exception $e) {
    ...
    function register(Request $request)
    {
        try {
            ...
            $user->verification_code = rand(10000,100000);
            $user->save();
    ...
    public function userVerify(Request $request)
    {
        ...
        return $this->sendError('You must semd verification code', 400);
    }
}
